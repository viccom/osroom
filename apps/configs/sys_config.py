...
PLUG_IN_REQUIRED_CONF = ["startup_file_name","hook_name", "alias_name", "introduce",
                        "version", "license"]
# 插件配置缓存
...
THEME_REQUIRED_CONF = ["theme_name", "cover_path","introduce","version", "license"]
...
'''
 权限permission
'''
# 必须ROOT权限用户才能在管理端设置的配置(网站配置功能)
MUST_ROOT_SETTING = ["permission"]
...
'''
# 不存在的请求警告
METHOD_WARNING = gettext("405, The method is not allowed for the requested URL")

'''
 Babel
'''
# 多语言
BABEL_TRANSLATION_DIRECTORIES = "transations/admin_pages;transations/python-pg;transations/theme"

'''
第三方登录插件支持
'''
LOGIN_PLATFORM = ["wechat", "qq", "sina_weibo", "alipay","github", "facebook", "twitter"]
